...
/*cabeçalho e back top btn ativos quando rolar para baixo até 100px*/
...
AOS.init({
  ...
  once: true, // A animação será executada uma vez apenas
  mirror: false, // Desativa animação quando o elemento sair da tela
});
